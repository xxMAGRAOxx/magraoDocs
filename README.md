...
# Tratando erros
Erros podem acontecer em todas as etapas(Complete, Update, Validate, Checkout e Download) e será de sua responsabilidade tratá-los e informar ao Usuário, se for o caso. Independente da requisição que esteja sendo feita, sempre retornaremos uma Exception com o código e mensagem do erro. Você pode verificar <a target="blank" href="https://github.com/xxMAGRAOxx/magraoDocs/blob/master/errors.md">aqui</a> uma lista dos possíveis erros que podem acontecer em suas respectivas etapas. Disponibilizamos também uma <a target="blank" href="https://github.com/bibliomundi/client-side-api/tree/master/docs/">documentação</a> gerada pelo <a target="blank" href="http://www.phpdoc.org/">PHPDoc.</a>
